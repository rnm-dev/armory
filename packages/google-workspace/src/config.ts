...
export type ServiceAccountCredentials = {
  type: "service_account"; client_email: string; private_key: string; private_key_id?: string; project_id?: string;
};

export const configPath = (home: string): string => path.join(home, "config", "google-workspace.json");
